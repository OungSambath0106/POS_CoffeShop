<div class="sidebar p-0">
    <div class="d-flex flex-column flex-shrink-0 text-white sidebar-container">
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            ...
            <li>
                <a href="{{ route('customer.index') }}" class="nav-link py-4 mb-5 icon"><i class="fa-solid fa fa-users fa-3x"
                        style="color: #ffffff;"></i></a>
            </li>
            <li>
                <a href="{{ route('users.index') }}" class="nav-link py-4 mb-5 icon"><i class="fa-solid fa-address-book fa-3x"
                        style="color: #ffffff;"></i></a>
            </li>
        </ul>
